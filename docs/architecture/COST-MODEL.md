...
|---|---|---:|---:|
| App Platform web | fixed 1 GiB service | $10/mo | ~$14/mo |
| App Platform API | fixed 1 GiB service | $10/mo | ~$14/mo |
| App Platform worker | shared 512 MiB worker | $5/mo | ~$7/mo |
| Managed PostgreSQL | basic 1 GiB / 1 vCPU starting tier | $15/mo | ~$21/mo |
...
| **Estimated total with Spaces** | excludes domain, taxes, bandwidth overages, support, and one-time setup | **$45-$65/mo** | **~$62-$90/mo** |
| **Estimated total without Spaces** | prepared deployment baseline | **$40-$60/mo** | **~$55-$83/mo** |
...
- App Platform currently lists the shared 512 MiB plan at $5/month and the fixed 1 GiB plan at $10/month. The prepared production topology uses separate web and API services plus a worker. Jobs are billed only while they run; the PRE_DEPLOY migration job is therefore not a fixed monthly line.
- Managed PostgreSQL basic 1 GiB / 1 vCPU starts at $15/month. Recheck the selected cluster quote before purchase.
...
- [DigitalOcean App Platform pricing](https://docs.digitalocean.com/products/app-platform/details/pricing/) - VERIFIED 2026-08-12.
- [DigitalOcean managed databases pricing](https://docs.digitalocean.com/products/databases/postgresql/details/pricing/) - VERIFIED 2026-08-12.
- [DigitalOcean Spaces pricing](https://docs.digitalocean.com/products/spaces/details/pricing/) - VERIFIED 2026-08-11.
- [DigitalOcean regional availability](https://docs.digitalocean.com/platform/regional-availability/) - VERIFIED 2026-08-12.
- [Cloudflare Free plan](https://www.cloudflare.com/plans/free/) - VERIFIED 2026-08-11.
- [Resend pricing](https://resend.com/pricing) - VERIFIED 2026-08-12.
